jQuery(document).ready(function (d) {
            ...
            : s.parents(".cd-headline").hasClass("letters")
                ? ((e = s.children("i").length >= a.children("i").length),
                    (function s(i, e, a, n) {
                        ...
                        {
                            var t;
                            i.is(":last-child") && d("html").hasClass("no-csstransitions") && ((t = w(e)), v(e, t));
                        }
                    })(s.find("i").eq(0), s, e, r),
    ...
    function C(s, i) {
        s.parents(".cd-headline").hasClass("type")
            ? (m(s.find("i").eq(0), s, !1, i), s.addClass("is-visible").removeClass("is-hidden"))
            : s.parents(".cd-headline").hasClass("clip") &&
            s.parents(".cd-words-wrapper").animate({ width: s.width() + 10 }, p, function () {
                setTimeout(function () {
                    f(s);
                }, e);
            });
    ...
    s.each(function () {
        ...
        a.hasClass("loading-bar")
            ...
            : a.hasClass("clip")
                ? ((s = (i = a.find(".cd-words-wrapper")).width() + 10), i.css("width", s))
                : a.hasClass("type") ||
