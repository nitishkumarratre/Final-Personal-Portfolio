...
!(function (e, t) {
    ...
    function P(e) {
        return (
            (we = e || r()) &&
                ...
                (Pe = k.isTouch = Te.matchMedia && Te.matchMedia("(hover: none), (pointer: coarse)").matches ? 1 : "ontouchstart" in Te || 0 < navigator.maxTouchPoints || 0 < navigator.msMaxTouchPoints ? 2 : 0),
                (De = k.eventTypes = ("ontouchstart" in ke ? "touchstart,touchmove,touchcancel,touchend" : "onpointerdown" in ke ? "pointerdown,pointermove,pointercancel,pointerup" : "mousedown,mousemove,mouseup,mouseup").split(",")),
                setTimeout(function () {
                    return (o = 0);
                }, 500),
                O(),
        ...
        ((Observer.prototype.init = function init(e) {
            ...
            function Ue() {
                ...
                T && (r || n) && T(se, e, t, be, me),
                    ...
                    n && (w && 0 < se.deltaY && w(se), x && se.deltaY < 0 && x(se), S && S(se), E && se.deltaY < 0 != ce < 0 && E(se), (ce = se.deltaY), (me[0] = me[1] = me[2] = 0)),
            ...
            (te = se._dc = we
                ...
                (se.disable = function () {
                    se.isEnabled &&
                        ...
                        se.isPressed && (se._vx.reset(), se._vy.reset(), C(I ? i : ve, De[1], Xe, !0)),
    ...
    function wb(e, t, r, n, o, i, a, s) {
        ...
        return (
            ...
            (!h && !s && g) || (y += (n === Ne ? S : T) + ":" + (i + parseFloat(f)) + "px;"),
    ...
    function Eb() {
        ze.cache++, rt || h || He.fullscreenElement || He.webkitFullscreenElement || (b && y === je.innerWidth && !(Math.abs(je.innerHeight - m) > 0.25 * je.innerHeight)) || c.restart(!0);
    }
    function Hb() {
    ...
    function dc(e, t, r, n, o, i, a, s, l, c, u, f, p) {
        ...
        if ((p && p.seek(0), Na(e))) a && q(a, r, n, !0);
            ...
            var b,
                ...
                w = (e || "0").split(" ");
            (h = J(t) || Ge),
                ((b = kt(h) || {}) && (b.left || b.top)) || "none" !== fb(h).display || ((x = h.style.display), (h.style.display = "block"), (b = kt(h)), x ? (h.style.display = x) : h.style.removeProperty("display")),
                (m = vb(w[0], b[n.d])),
                (y = vb(w[1] || "0", r)),
    ...
    var Je,
        ...
        kt = function _getBounds(e, t) {
            var r = t && "matrix(1, 0, 0, 1, 0, 0)" !== fb(e)[f] && Je.to(e, { x: 0, y: 0, xPercent: 0, yPercent: 0, rotation: 0, rotationX: 0, rotationY: 0, scale: 1, skewX: 0, skewY: 0 }).progress(1),
        ...
        $ =
            ((ScrollTrigger.prototype.init = function init(M, T) {
                if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), ht)) {
                    var C,
                        ...
                        S,
                        i,
                        $ = (M = hb(La(M) || Na(M) || M.nodeType ? { trigger: M } : M, Pt)).onUpdate,
                        ee = M.toggleClass,
                        a = M.id,
                        te = M.onToggle,
                        re = M.onRefresh,
                    ...
                    if (
                        ...
                        (Se.vars = M),
                        (T = T || M.animation),
                        "refreshPriority" in M && ((it = 1), -9999 === M.refreshPriority && (ft = Se)),
                        (c.tweenScroll = c.tweenScroll || { top: gc(be, Ne), left: gc(be, Ye) }),
                        ...
                        T &&
                            ((T.vars.lazy = !1),
                            T._initted || (!1 !== T.vars.immediateRender && !1 !== M.immediateRender && T.duration() && T.render(0, !0, !0)),
                        ...
                        ue &&
                            ...
                            "scrollBehavior" in Ge.style && Je.set(me ? [Ge, Ke] : be, { scrollBehavior: "auto" }),
                            ze.forEach(function (e) {
                                    ...
                                    if (e <= O && P <= e && c !== e) {
                                        ...
                                        !1 === ue.inertia && (a = l - n),
                                            C(
                                                c,
                                                {
                                                    duration: g(vt((0.185 * Math.max(vt(s - o), vt(l - o))) / i / 0.05 || 0)),
                                                    ease: ue.ease || "power3",
                                                    data: vt(c - e),
                        ...
                        ie &&
                            (!1 === ae || ae === Mt || (ae = !(!ae && ie.parentNode && ie.parentNode.style && "flex" === fb(ie.parentNode).display) && St),
                            (Se.pin = ie),
                            (n = Je.core.getCache(ie)).spacer
                                ? (F = n.pinState)
                                : (l && ((l = J(l)) && !l.nodeType && (l = l.current || l.nativeElement), (n.spacerIsNative = !!l), l && (n.spacerState = ac(l))),
                    ...
                    (Se.previous = function () {
                        ...
                        (Se.revert = function (e, t) {
                            ...
                            var r = !1 !== e || !Se.enabled,
                                n = rt;
                            r !== Se.isReverted &&
                                (r && ((Q = Math.max(Pe(), Se.scroll.rec || 0)), (G = Se.progress), (Z = T && T.progress())),
                                A &&
                                ...
                                if (ie && e && gt) pb(ScrollTrigger, "scrollEnd", Hb);
                                    ...
                                    for (
                                        var r,
                                            ...
                                            m = M.end,
                                            y = M.endTrigger || oe,
                                            x = M.start || (0 !== M.start && oe ? (ie ? "0 0" : "0 100%") : 0),
                                            w = (Se.pinnedContainer = M.pinnedContainer && J(M.pinnedContainer)),
                                            _ = (oe && Math.max(0, Ot.indexOf(Se))) || 0,
                                            S = _;
                                        S--;

                                    )
                                        (s = Ot[S]).end || s.refresh(0, 1) || (rt = 1), !(l = s.pin) || (l !== oe && l !== ie) || s.isReverted || ((f = f || []).unshift(s), s.revert(!0, !0)), s !== Ot[S] && (_--, S--);
                                    for (
                                        Ma(x) && (x = x(Se)),
                                            P = dc(x, oe, d, he, Pe(), A, D, Se, g, _e, ye, h, pe) || (ie ? -0.001 : 0),
                                            Ma(m) && (m = m(Se)),
                                            La(m) && !m.indexOf("+=") && (~m.indexOf(" ") ? (m = (La(x) ? x.split(" ")[0] : "") + m) : ((v = vb(m.substr(2), d)), (m = La(x) ? x : P + v), (y = oe))),
                                            O = Math.max(P, dc(m || (y ? "100% 0" : h), y, d, he, Pe() + v, B, L, Se, g, _e, ye, h, pe)) || -0.001,
                                            R = O - P || ((P -= 0.01) && 0.001),
                                            v = 0,
                                            S = _;
                                        S--;
                                        ...
                                        (l = (s = Ot[S]).pin) &&
                                            ...
                                            !pe &&
                                            0 < s.end &&
                                            ((r = s.end - s.start), ((l === oe && s.start - s._pinPush < P) || l === w) && !Na(x) && (v += r * (1 - s.progress)), l === ie && (b += r));
                                    if (((P += v), (O += v), (Se._pinPush = b), A && v && (((r = {})[he.a] = "+=" + v), w && (r[he.p] = "-=" + Pe()), Je.set([A, B], r)), ie))
                                        (r = fb(ie)),
                                            (i = he === Ne),
                                            (o = Pe()),
                                            (N = parseFloat(Y(he.a)) + b),
                                            !h && 1 < O && ((p = { style: (p = (me ? He.scrollingElement || Ke : be).style), value: p["overflow" + he.a.toUpperCase()] })["overflow" + he.a.toUpperCase()] = "scroll"),
                                            Zb(ie, X, r),
                                            (I = ac(ie)),
                                            (n = kt(ie, !0)),
                                            (c = ye && K(be, i ? Ye : Ne)()),
                                            ae &&
                                                ...
                                                (S = ae === St ? jb(ie, he) + R + b : 0) && U.push(he.d, S + Ct),
                                                Rt(U),
                                                w &&
                                                    Ot.forEach(function (e) {
                                                ...
                                                ye && Pe(Q)),
                                            ye &&
                                                (((a = { top: n.top + (i ? o - P : c) + Ct, left: n.left + (i ? c : o - P) + Ct, boxSizing: "border-box", position: "fixed" })[bt] = a.maxWidth = Math.ceil(n.width) + Ct),
                                                (a[mt] = a.maxHeight = Math.ceil(n.height) + Ct),
                                                (a[Mt] = a[Mt + wt] = a[Mt + yt] = a[Mt + _t] = a[Mt + xt] = "0"),
                                                (a[St] = r[St]),
                                                (a[St + wt] = r[St + wt]),
                                                (a[St + yt] = r[St + yt]),
                                                (a[St + _t] = r[St + _t]),
                                    ...
                                    f &&
                                        ...
                                        Se.revert(!1, !0),
                                        W && ((ke = -1), Se.isActive && Pe(P + R * G), W.restart(!0)),
                                        (rt = 0),
                                        T && ve && (T._initted || Z) && T.progress() !== Z && T.progress(Z, !0).render(T.time(), !0, !0),
                                        (G === Se.progress && !pe) || (T && !ve && T.totalProgress(pe && P < -0.001 ? Je.utils.mapRange(P, O, 0, 1, G) : G, !0), (Se.progress = (k - P) / R === G ? 0 : G)),
                        ...
                        (Se.update = function (e, t, r) {
                            if (!pe || r || e) {
                                var n,
                                    ...
                                    d = Se.progress;
                                if (
                                    (t && ((E = k), (k = pe ? Pe() : u), ue && ((_ = w), (w = T && !ve ? T.totalProgress() : p))),
                                    le && !p && ie && !rt && !pt && gt && P < u + ((u - E) / (dt() - tt)) * le && (p = 1e-4),
                                    p !== d && Se.enabled)
                                ) {
                                    if (
                                        ...
                                        (Se.progress = p),
                                        a && !rt && ((o = p && !d ? 0 : 1 === p ? 1 : 1 === d ? 2 : 3), ve && ((i = (!s && "none" !== we[o + 1] && we[o + 1]) || we[o]), (c = T && ("complete" === i || "reset" === i || i in T)))),
                                        ge &&
                                            (s || c) &&
                                            (c || ne || !T) &&
                                            (Ma(ge)
                                        ...
                                        ve ||
                                            (!H || rt || pt
                                                ...
                                                : (H._dp._time - H._start !== H._time && H.render(H._dp._time - H._start),
                                                  H.resetTo ? H.resetTo("totalProgress", p, T._tTime / T._tDur) : ((H.vars.totalProgress = p), H.invalidate().restart()))),
                                        ie)
                                    )
                                    ...
                                    !ue || C.tween || rt || pt || W.restart(!0),
                                        ...
                                        !$ || ve || e || $(Se),
                                        a && !rt
                                            ? (ve && (c && ("complete" === i ? T.pause().totalProgress(1) : "reset" === i ? T.restart(!0).pause() : "restart" === i ? T.restart(!0) : T[i]()), $ && $(Se)),
                                              (!s && lt) || (te && s && Qa(Se, te), xe[o] && Qa(Se, xe[o]), ce && (1 === p ? Se.kill(!1, 1) : (xe[o] = 0)), s || (xe[(o = 1 === p ? 1 : 3)] && Qa(Se, xe[o]))),
                                              de && !n && Math.abs(Se.getVelocity()) > (Na(de) ? de : 2500) && (Pa(Se.callbackAnimation), H ? H.progress(1) : Pa(T, "reverse" === i ? 1 : !p, 1)))
                                            : ve && $ && !rt && $(Se);
                                }
                                if (x) {
                        ...
                        (Se.enable = function (e, t) {
                            Se.enabled ||
                                ((Se.enabled = !0), pb(be, "resize", Eb), pb(me ? He : be, "scroll", Cb), Me && pb(ScrollTrigger, "refreshInit", Me), !1 !== e && ((Se.progress = G = 0), (k = E = ke = Pe())), !1 !== t && Se.refresh());
                        }),
                        ...
                        (Se.disable = function (e, t) {
                            if (
                                ...
                                for (var r = Ot.length; r--; ) if (Ot[r].scroller === be && Ot[r] !== Se) return;
            ...
            (ScrollTrigger.config = function config(e) {
                ...
                (t && clearInterval(u)) || ((u = t) && setInterval(Bb, t)),
                    ...
                    "autoRefreshEvents" in e && (Ka(qb) || Ka(pb, e.autoRefreshEvents || "none"), (h = -1 === (e.autoRefreshEvents + "").indexOf("resize")));
            }),
    ...
    function qc(e) {
        ...
        return (
            ...
            (e.onRelease = e.onGestureStart = function (e, t) {
                if ((b.offset && Kp(), t)) {
                    ...
                    var r,
                        n,
                        o = _();
                    f && ((n = (r = m()) + (0.05 * o * -e.velocityX) / 0.227), (o *= ic(m, r, n, Ja(d, Ye))), (a.vars.scrollX = M(n))),
                        (n = (r = b()) + (0.05 * o * -e.velocityY) / 0.227),
                        (o *= ic(b, r, n, Ja(d, Ne))),
                        (a.vars.scrollY = T(n)),
                        a.invalidate().duration(o).play(0.01),
                        ((E && a.vars.scrollY >= i) || i - 1 <= r) && Je.to({}, { onUpdate: Qp, duration: o });
                } else s.restart(!0);
                p && p(e);
            }),
            (e.onWheel = function () {
            ...
            E && Je.ticker.add(Ba),
            (s = n._dc),
            (a = Je.to(n, { ease: "power4", paused: !0, scrollX: f ? "+=0.1" : "+=0", scrollY: "+=0.1", onUpdate: j, onComplete: s.vars.onComplete })),
            n
        );
    }
    var ee,
