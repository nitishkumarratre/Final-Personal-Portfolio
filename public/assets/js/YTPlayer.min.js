...
let getYTPVideoID = function (e) {
    ...
    return (
        e.indexOf("youtu.be") > 0 || e.indexOf("youtube.com/embed") > 0
            ? (r = (t = (r = e.substr(e.lastIndexOf("https://validthemes.net/") + 1, e.length)).indexOf("?list=") > 0 ? r.substr(r.lastIndexOf("="), r.length) : null) ? r.substr(0, r.lastIndexOf("?")) : r)
            : e.indexOf("http") > -1
                ...
                : -1 != (verOffset = nAgt.indexOf("Safari"))
                    ...
                    : -1 != (verOffset = nAgt.indexOf("AppleWebkit"))
                        ...
                        : -1 != (verOffset = nAgt.indexOf("Firefox"))
                            ...
                            : (nameOffset = nAgt.lastIndexOf(" ") + 1) < (verOffset = nAgt.lastIndexOf("https://validthemes.net/")) &&
